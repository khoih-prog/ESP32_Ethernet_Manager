...
#ifndef ESP32_Ethernet_Manager_hpp
#define ESP32_Ethernet_Manager_hpp
...
#define ESP32_ETH_MANAGER_VERSION           "ESP32_Ethernet_Manager v1.0.0"

#define ESP32_ETH_MANAGER_VERSION_MAJOR     1
#define ESP32_ETH_MANAGER_VERSION_MINOR     0
#define ESP32_ETH_MANAGER_VERSION_PATCH     0

#define ESP32_ETH_MANAGER_VERSION_INT       1000000

////////////////////////////////////////////////////

#include "ESP32_Ethernet_Manager_Debug.h"
...
class ESP32_EMParameter 
{
  ...
  private:
    ...
    friend class ESP32_Ethernet_Manager;
};
...
class ESP32_Ethernet_Manager
{
  public:

    ESP32_Ethernet_Manager(const char *iHostname = "");
...
#endif    // ESP32_Ethernet_Manager_hpp
